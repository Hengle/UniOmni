...
namespace UnityEditor.Searcher
{
    ...
    public class SearcherExampleComponentEditor : Editor
    {
        Rect m_ButtonRect;
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (var i = 0; i < 10; ++i)
                children.Add(new SearcherItem("B-" + i.ToString()));
...

            {
                ...
                if (EditorGUILayout.DropdownButton(new GUIContent("Button"), FocusType.Passive, GUI.skin.button))
                {
                    ...
                    var worldMousePosition = editorWindow.GetRootVisualContainer().LocalToWorld(localMousePosition);
...

            {
                ...
                if (selected)
                {
                    ...
                    var worldButtonCenter = editorWindow.GetRootVisualContainer().LocalToWorld(localButtonCenter);
