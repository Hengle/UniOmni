...
{
    public class SearcherExampleWindow : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            var searcher = new Searcher(new SearcherDatabaseBase[]{ foodDatabase, bookDatabase }, "Popup Example");

            var searcherControl = new SearcherControl();
            searcherControl.Setup(searcher, x => Debug.Log(x != null ? x.name : "none"), null);

            this.rootVisualElement.Add(searcherControl);
        }
    }
}
