...
namespace UnityEditor.Searcher.Tests
{
    ...
    {
        private static TestCaseData[] Make(string prefix, TestCaseData[] input)
        {
        ...
        private static TestCaseData[] BasicCases() => Make("Basic ", new[]
        {
        ...
        public static TestCaseData[] PrefixCases() => Make("Prefix", new[]
        {
        ...
        public static TestCaseData[] CamelCaseSplitCases() => Make("CamelCase", new[]
        {
            new TestCaseData("GameObject OnDestroy", "o x", false),
//            new TestCaseData("OnDestroy", "on destroy", true),
//            new TestCaseData("GameObject OnDestroy", "game object on destroy", true),
//            new TestCaseData("GameObject OnDestroy", "g o o d", true),
//            new TestCaseData("GameObject OnDestroy", "o o d", true),
//            new TestCaseData("GameObject OnDestroy", "o d", true),
//            new TestCaseData("GameObject OnDestroy", "g  o  o  d", true),
        });
        ...
        public void Match(string path, string query, bool expectedResult)
        {
            ...
            bool actual = (bool)m.Invoke(null, parameters);
        ...
        private static IEnumerable<TestCaseData> FilterCases
        {
            get
            {
                ...
                var query = "tr";
                Func<string, SearcherItem, bool> filter = null;
                yield return new TestCaseData(origin, query, filter, expectedResult).SetName("Query with no filter");

                origin = new List<SearcherItem> { new SearcherItem("transform") };
                expectedResult = new List<SearcherItem>();
                query = "tr";
                filter = (q, item) => !item.name.StartsWith("trans", StringComparison.Ordinal);
